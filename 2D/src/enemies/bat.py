...
class Bat(Enemy):
    ...
    def move(self):
        ...
        self.pos.y += math.sin(pygame.time.get_ticks() / 500) * self.speed  # Movimiento oscilante hacia arriba y abajo
        ...
        if self.pos.y > self.gameManager.HEIGHT - self.rect.height:
            self.pos.y = self.gameManager.HEIGHT - self.rect.height  # Evitar que se salga por abajo
        if self.pos.y < 0:
